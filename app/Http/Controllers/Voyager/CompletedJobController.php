...
class CompletedJobController extends VoyagerBaseController
{
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $query = $model::select('*');
            // $query = CompletedJob::select('*')->leftJoin('reviews', function ($query) {
            //      $query
            //      ->on('reviews.completed_job_id', '=', 'completed_jobs.id');
            //  })
    ...
    public function review($id)
    {
        ...
        return redirect()->route('voyager.completed-jobs.index');
    }
}