...
use App\{User, PaperPeriod, PaperClassification, OrderDetail, PickedJob, CompletedJob, DefferedJob, Product, Payable};
use TCG\Voyager\Http\Controllers\VoyagerBaseController;
use Illuminate\Support\Facades\Storage;

class PayableController extends VoyagerBaseController
{
    ...
    public function getPay($id)
    {
        ...
        return view('vendor.voyager.payables.pay', compact('payable', 'TotalMoneyOwed'));
    }
}