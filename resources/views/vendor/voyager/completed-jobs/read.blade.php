                ...
                <div class="card border-primary col-md-6">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            {{ $completedJob['orderDetail']['files'] }}
                        </p>
                        <a class="btn btn-sm btn-primary mx-auto d-block" href="{{ url( 'download', [$completedJob['orderDetail']['files']])  }}">Download</a>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="card col-md-6">
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <a class="btn btn-sm btn-primary mx-auto d-block" href="{{ url( 'download', [$completedJob['files']])  }}">
                                Download
                            </a>
                        @endif
                    </div>
